(function () {
  ...
  // i18n helper — returns achievements translations (or empty fallback)
  function useA() {
    if (!useI18n) return null;
    var i = useI18n();
    return i && i.t && i.t.achievements ? i.t.achievements : null;
  }
  ...
  function ShareDialog({ achievement, onClose }) {
    const [status, setStatus] = hooks.useState("rendering");
    var a = useA(); // rendering | ready | copied | error
  ...
  function TierLegend() {
    var a = useA();
    var tierNames = {
      "Copper": a ? a.copper : "Copper",
      "Silver": a ? a.silver : "Silver",
      "Gold": a ? a.gold : "Gold",
      "Diamond": a ? a.diamond : "Diamond",
      "Olympian": a ? a.olympian : "Olympian"
    };
  ...
  function LoadingPage() {
    return React.createElement("div", { className: "ha-page ha-page-loading" },
      ...
      React.createElement("section", { className: "ha-guide ha-loading-guide" },
        React.createElement("div", null,
          React.createElement("strong", null, a ? a.scanStatus : "Scan status"),
        ...
        React.createElement("div", null,
          React.createElement("strong", null, a ? a.whatIsScanned : "What is scanned"),
          React.createElement("p", null, a ? a.whatIsScannedDesc : "Sessions, tool calls, model metadata, errors, achievements, and local unlock state.")
        )
      ),
  ...
  function AchievementCard({ achievement }) {
    ...
    var a = useA();
    var stateLabels = {
      "unlocked": a ? a.stateUnlocked : "Unlocked",
      "secret": a ? a.stateSecret : "Secret",
      "discovered": a ? a.stateDiscovered : "Discovered"
    };
    const stateLabel = stateLabels[state] || state;
    const targetTier = achievement.next_tier || achievement.tier;
    const tierLabel = achievement.tier ? achievement.tier : (targetTier ? ((a ? a.target : "Target") + " " + targetTier) : (state === "secret" ? (a ? a.hidden : "Hidden") : (unlocked ? (a ? a.complete : "Complete") : (a ? a.objective : "Objective"))));
    const progressText = state === "secret" ? (a ? a.hidden : "hidden") : (progress + (achievement.next_threshold ? " / " + achievement.next_threshold : ""));
    ...
    return React.createElement(C.Card, { className: cn("ha-card", "ha-state-" + state, tierClass(achievement.tier || achievement.next_tier)) },
      React.createElement(C.CardContent, { className: "ha-card-content" },
        React.createElement("div", { className: "ha-card-head" },
          ...
          React.createElement("div", { className: "ha-badges" },
            ...
            state === "unlocked" && React.createElement("button", {
              ...
              title: a ? a.share : "Share this achievement",
              "aria-label": (a ? a.share : "Share") + " " + achievement.name,
            }, a ? a.share : "Share")
          )
        ),
        ...
        achievement.criteria && React.createElement("details", { className: "ha-criteria" },
          React.createElement("summary", null, state === "secret" ? (a ? a.howToReveal : "How to reveal") : (a ? a.whatCounts : "What counts")),
        ...
        React.createElement("div", { className: "ha-evidence-slot" },
          achievement.evidence ? React.createElement("div", { className: "ha-evidence" },
            React.createElement("span", { className: "ha-evidence-label" }, a ? a.evidence : "Evidence"),
  ...
  function AchievementsPage() {
    ...
    const highest = ["Olympian", "Diamond", "Gold", "Silver", "Copper"].find(function (tier) { return unlocked.some(function (ach) { return ach.tier === tier; }); }) || (a ? a.noneYet : "None yet");
    ...
    if (scanInFlight) {
      ...
      const detail = total > 0
        ...
        : (a ? a.scanReadingNote : "Reading sessions, tool calls, model metadata, and unlock state. Badges appear here as they unlock.");
    ...
    return React.createElement("div", { className: "ha-page" },
      React.createElement("section", { className: "ha-hero" },
        React.createElement("div", null,
          React.createElement("div", { className: "ha-kicker" }, a ? a.kicker : "Agentic Gamerscore"),
          React.createElement("h1", null, a ? a.title : "Hermes Achievements"),
          React.createElement("p", null, a ? a.subtitle : "Collectible Hermes badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.")
        ),
        React.createElement(C.Button, { onClick: load, className: "ha-refresh" }, a ? a.rescan : "Rescan")
      ),
      scanBanner,
      ...
      React.createElement("section", { className: "ha-guide" },
        React.createElement("div", null,
          React.createElement("strong", null, a ? a.tiers : "Tiers"),
          React.createElement(TierLegend, null)
        ),
        React.createElement("div", null,
          React.createElement("strong", null, a ? a.secretAchievements : "Secret achievements"),
          React.createElement("p", null, a ? a.secretDesc : "Secrets hide their exact trigger. Once Hermes sees a related signal, the card becomes Discovered and shows its requirement.")
        )
      ),
      ...
      latest.length > 0 && React.createElement("section", { className: "ha-latest" },
        React.createElement("h2", null, a ? a.recentUnlocks : "Recent unlocks"),
