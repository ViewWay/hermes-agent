...
export const zh: Translations = {
  ...
  analytics: {
    ...
    toolCallCount: "次调用",
    percentage: "占比",
    hourlyConsumption: "每小时 Token 消耗",
    hourlyTokens: "tokens",
    cacheHit: "缓存命中",
    cacheMiss: "缓存未命中",
    cacheHitRate: "缓存命中率",
    activityPatterns: "活跃时段",
    byDayOfWeek: "按星期",
    byHour: "按小时",
    busiestDay: "最活跃日",
    busiestHour: "最活跃时段",
    activeDays: "活跃天数",
    maxStreak: "最长连续",
    notableSessions: "亮点会话",
    longestSession: "最长会话",
    mostMessages: "最多消息",
    mostTokens: "最多 Token",
    mostToolCalls: "最多工具调用",
    platforms: "平台",
    ...
    skillNeverUsed: "未使用",
    skillCleanup: "自动清理",
    skillCleanupDesc: "禁用该时间段内从未使用的技能",
    skillCleanupPreview: "预览清理",
    skillCleanupConfirm: "确认清理",
  },
