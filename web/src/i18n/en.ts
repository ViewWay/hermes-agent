...
export const en: Translations = {
  ...
  analytics: {
    ...
    hourlyConsumption: "Hourly Token Consumption",
    hourlyTokens: "tokens",
    cacheHit: "Cache Hit",
    ...
    notableSessions: "Notable Sessions",
    longestSession: "Longest Session",
    mostMessages: "Most Messages",
    mostTokens: "Most Tokens",
    mostToolCalls: "Most Tool Calls",
    platforms: "Platforms",
    ...
    skillActive: "Active",
    skillIdle: "Idle",
    skillNeverUsed: "Never Used",
    skillCleanup: "Auto Cleanup",
    skillCleanupDesc: "Disable skills never used in this period",
    skillCleanupPreview: "Preview Cleanup",
    skillCleanupConfirm: "Confirm Cleanup",
  },
